...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="alert alert-success" role="alert">
                ...
                {{ session()->get('resprod') }} - {{ session()->get('resimg') }}
            </div>
        </div>
    </div>
    @endif
    ...
    <table class="table table-hover">
        ...
        <tr>
            ...
            <td class="text-center"><a href="#" data-id="{{ $producto->id }}" data-content="{{ $producto->nombre }}"
                    data-toggle="modal" data-target="#modalDelete" class="launchModal">Delete</a></td>
        </tr>
        @endforeach
